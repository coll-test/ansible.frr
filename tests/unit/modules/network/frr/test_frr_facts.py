...
from ansible_collections.ansible.frr.tests.unit.compat.mock import patch
from ansible_collections.ansible.frr.plugins.modules import frr_facts
from ansible_collections.ansible.frr.tests.unit.modules.utils import set_module_args
...
class TestFrrFactsModule(TestFrrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.frr.plugins.modules.frr_facts.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_get_capabilities = patch('ansible_collections.ansible.frr.plugins.modules.frr_facts.get_capabilities')
